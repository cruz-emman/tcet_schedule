...
import { ArrowBigLeft, ArrowBigRight, CalendarIcon, icons, Loader2, Plus, Trash, Trash2 } from 'lucide-react';
...
const EditAppointment = ({ params }: EditPostPageProps) => {
  ...
  return (
    ...
    <div className='m-4 p-4 shadow-2xl border-2  '>
      ...
      <div className='flex flex-col md:flex-row justify-between md:items-center gap-2 mb-10'>
